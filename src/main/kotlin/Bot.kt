            ...
            val response = client.submitForm<ImageFlipResponse>(
                ...
                formParameters = Parameters.build {
                    ...
                    if (!template.equals("meeting")) {
                        ...
                        append("boxes[0][y]", "50")
                        append("boxes[0][width]", "300")
                        append("boxes[0][height]", "50")
                        append("boxes[0][color]", "#ffffff")
                        append("boxes[0][outline_color]", "#000000")

                        append("boxes[1][text]", text1)
                        append("boxes[1][x]", "75")
                        append("boxes[1][y]", "260")
                        append("boxes[1][width]", "100")
                        append("boxes[1][height]", "30")
                        append("boxes[1][color]", "#ffffff")
                        append("boxes[1][outline_color]", "#000000")

                        append("boxes[2][text]", text2)
                        append("boxes[2][x]", "200")
                        append("boxes[2][y]", "270")
                        append("boxes[2][width]", "85")
                        append("boxes[2][height]", "30")
                        append("boxes[2][color]", "#ffffff")
                        append("boxes[2][outline_color]", "#000000")

                        append("boxes[3][text]", text3)
                        append("boxes[3][x]", "360")
                        append("boxes[3][y]", "280")
                        append("boxes[3][width]", "150")
                        append("boxes[3][height]", "50")
                        append("boxes[3][color]", "#ffffff")
                        append("boxes[3][outline_color]", "#000000")
                    }
                })
